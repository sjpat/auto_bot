...
class TestKalshiClient:
    ...
    def test_get_markets(self, config):
        ...
        async def _test():
            ...
            client.markets.get_markets.return_value = Mock(
                markets=[Mock(**mock_markets["markets"][0])]
            )
    ...
    def test_create_order(self, config):
        ...
        async def _test():
            ...
            order = await client.create_order(
                market_id="MARKET1", side="buy", quantity=100, price=0.65
            )
