...
class TestPaperTrading:
    ...
    def test_initialization(self, config):
        ...
        async def _test():
            ...
            paper_client = PaperTradingClient(
                kalshi_client=mock_real_client, starting_balance=1000.0
            )
    ...
    def test_create_order(self, config):
        ...
        async def _test():
            ...
            order = await paper_client.create_order(
                market_id="MARKET001", side="buy", quantity=100, price=0.65
            )
    ...
    def test_insufficient_balance(self, config):
        ...
        async def _test():
            mock_real_client = Mock()
            paper_client = PaperTradingClient(
                kalshi_client=mock_real_client, starting_balance=10.0  # Only $10
            )
    ...
    def test_slippage_simulation(self, config):
        ...
        async def _test():
            ...
            assert (
                ...
                or order.avg_fill_price == order.price
            )
