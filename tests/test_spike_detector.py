...
class TestSpikeDetector:
    ...
    def test_add_price(self, config, sample_market):
        ...
        detector.add_price(
            market_id=sample_market.market_id, price=0.65, timestamp=datetime.now()
        )
    ...
    def test_spike_detection_upward(self, config, sample_market):
        ...
        for i in range(20):
            detector.add_price(
                market_id=sample_market.market_id, price=0.60, timestamp=datetime.now()
            )

        # Add a few prices at higher level
        for i in range(3):
            detector.add_price(
                market_id=sample_market.market_id, price=0.63, timestamp=datetime.now()
            )
    ...
    def test_spike_detection_downward(self, config, sample_market):
        ...
        for i in range(20):
            detector.add_price(
                market_id=sample_market.market_id, price=0.70, timestamp=datetime.now()
            )
